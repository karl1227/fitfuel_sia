...
try {
    ...
    if (!$user) {
        ...
        audit_log('auth', 'password_reset_request', 'success', [], ['email'=>$email, 'exists'=>false]);
        exit();
    }
    ...
    audit_log('auth', 'password_reset_request', 'success', ['email'=>$email], ['email'=>$email, 'reset_token'=>'generated']);
