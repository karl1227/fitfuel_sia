...
// Optional: show a cart quantity badge if you have cart tables
$cart_count = 0;
if ($logged_in) {
  try {
...
<html lang="en">
  ...
  <body class="font-body bg-white text-slate-600">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex space-x-8">
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a href="#">Lifting Straps</a>
                <a href="#">Gym Gloves</a>
                <a href="#">Weight Belts</a>
                <a href="#">Knee Wraps</a>
          ...
          <div class="flex items-center space-x-4">
            ...
            <a href="cart.php" class="relative p-2 text-white hover:text-emerald-600 transition-colors">
              ...
              <?php if ($cart_count > 0): ?>
                <span class="absolute -top-1 -right-1 bg-emerald-500 text-white text-xs rounded-full min-w-[18px] h-[18px] px-1 flex items-center justify-center">
                  <?php echo $cart_count; ?>
                </span>
              <?php endif; ?>
            </a>
            ...
            <?php else: ?>
              <a href="login.php" class="p-2 text-white hover:text-emerald-600 transition-colors" title="Login">
                <i class="fas fa-user text-xl"></i>
              </a>
            <?php endif; ?>
          </div>
    ...
    <!-- Hero Carousel -->
    <section class="carousel-container bg-gradient-to-r from-stone-10 to-stone-500">
      <div class="carousel-slide active">
        <div class="container mx-auto px-4 py-16">
          <div class="flex items-center justify-between">
            <div class="w-1/2">
              <h2 class="font-heading text-5xl font-bold text-slate-800 mb-4">Fuel Your Fitness Journey</h2>
              <p class="text-xl text-slate-600 mb-8">Premium gym equipment, supplements, and accessories for serious athletes</p>
              <a href="shop.php">
                <button class="bg-black text-white px-8 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-colors">
                  Shop Now
                </button>
              </a>
            </div>
            <div class="w-1/2">
              <img src="img/carousel/C1.png" alt="Gym Equipment" class="w-full h-auto rounded-lg shadow-lg"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-slide">
        <div class="container mx-auto px-4 py-16">
          <div class="flex items-center justify-between">
            <div class="w-1/2">
              <h2 class="font-heading text-5xl font-bold text-slate-800 mb-4">Premium Supplements</h2>
              <p class="text-xl text-slate-600 mb-8">Scientifically formulated nutrition to maximize your performance</p>
              <a href="shop.php">
                <button class="bg-black text-white px-8 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-colors">
                  Explore Supplements
                </button>
            ...
            <div class="w-1/2">
              <img src="img/carousel/C2.png" alt="Supplements" class="w-full h-auto rounded-lg shadow-lg"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-slide">
        <div class="container mx-auto px-4 py-16">
          <div class="flex items-center justify-between">
            <div class="w-1/2">
              <h2 class="font-heading text-5xl font-bold text-slate-800 mb-4">Essential Accessories</h2>
              <p class="text-xl text-slate-600 mb-8">Complete your workout with our range of premium accessories</p>
              <a href="shop.php">
                <button class="bg-black text-white px-8 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-colors">
                  View Accessories
                </button>
            ...
            <div class="w-1/2">
              <img src="img/carousel/C3.png" alt="Accessories" class="w-full h-auto rounded-lg shadow-lg"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Carousel Controls -->
      <button onclick="previousSlide()" class="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full p-3 shadow-lg transition-all">
        <i class="fas fa-chevron-left text-emerald-600"></i>
      </button>
      <button onclick="nextSlide()" class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full p-3 shadow-lg transition-all">
        <i class="fas fa-chevron-right text-emerald-600"></i>
      </button>

      <!-- Carousel Indicators -->
      <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
        <button onclick="currentSlide(1)" class="carousel-indicator active w-3 h-3 rounded-full bg-emerald-600"></button>
        <button onclick="currentSlide(2)" class="carousel-indicator w-3 h-3 rounded-full bg-white bg-opacity-50"></button>
        <button onclick="currentSlide(3)" class="carousel-indicator w-3 h-3 rounded-full bg-white bg-opacity-50"></button>
      </div>
    </section>
    ...
    <!-- Featured banner -->
    <section class="py-4 bg-slate-100 border-b border-gray-200">
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-center space-x-4">
          <i class="fas fa-star text-yellow-500"></i>
          <span class="font-semibold text-slate-700">Featured Products - Hand-picked by our fitness experts</span>
          <i class="fas fa-star text-yellow-500"></i>
        </div>
      </div>
    </section>
      ...
      <div class="w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 max-w-full h-[1300px]">
          <div class="product-card relative shadow-lg overflow-hidden">
            <img src="img/Featured/1.png" alt="Adjustable Dumbbells" class="w-full h-full object-cover"/>
            <div class="absolute inset-0 flex flex-col items-start justify-end text-start p-4">
              ...
              <a href="shop.php" class="bg-white text-black px-4 py-2 rounded-lg hover:bg-stone-200 transition-colors">SHOP NOW</a>
            </div>
          </div>

          <div class="product-card relative shadow-lg overflow-hidden">
            <img src="img/Featured/3.png" alt="Adjustable Dumbbells" class="w-full h-full object-cover"/>
            <div class="absolute inset-0 flex flex-col items-start justify-end text-start p-4">
          ...
          <div class="product-card relative shadow-lg overflow-hidden">
            <img src="img/Featured/4.png" alt="Adjustable Dumbbells" class="w-full h-full object-cover"/>
            <div class="absolute inset-0 flex flex-col items-start justify-end text-start p-4">
          ...
          <div class="product-card relative shadow-lg overflow-hidden">
            <img src="img/Featured/2.png" alt="Paralletes" class="w-full h-full object-cover"/>
            <div class="absolute inset-0 flex flex-col items-start justify-end text-start p-4">
    ...
    <section class="relative w-full">
      <img src="img/Banner/banner2.png" alt="Banner" class="w-full h-auto" />
      <div class="flex flex-col justify-center items-center text-center px-4">
        <h2 class="uppercase tracking-tight font-extrabold text-black md:text-7xl text-4xl mt-12 mb-6">FUELED-UP. WORKOUT-READY.</h2>
        <p class="text-base md:text-lg text-slate-600 mb-6 max-w-2xl">
          Hydration meets hustle. Gear up with gym essentials, from supplements to equipment.
        </p>
        <a href="shop.php" class="bg-black text-white px-6 py-3 rounded-lg font-semibold text-lg hover:bg-gray-800 transition-colors">
          Shop All Fitness
        </a>
      </div>
    </section>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="group relative overflow-hidden rounded-lg shadow-lg cursor-pointer">
            <img src="/placeholder.svg?height=300&width=400" alt="Gym Equipment" class="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"/>
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="text-center text-white">
                ...
                <a class="mt-4 inline-block bg-emerald-600 text-white px-6 py-2 rounded-lg hover:bg-emerald-700 transition-colors">Shop Now</a>
              </div>
            </div>
          </div>

          <div class="group relative overflow-hidden rounded-lg shadow-lg cursor-pointer">
            <img src="/placeholder.svg?height=300&width=400" alt="Supplements" class="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"/>
            <div class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition-all duration-300"></div>
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="text-center text-white">
          ...
          <div class="group relative overflow-hidden rounded-lg shadow-lg cursor-pointer">
            <img src="/placeholder.svg?height=300&width=400" alt="Accessories" class="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"/>
            <div class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition-all duration-300"></div>
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="text-center text-white">
    ...
    <footer class="bg-slate-800 text-white py-12">
      <div class="container mx-auto px-4">
        ...
        <div class="border-t border-slate-700 mt-8 pt-8 text-center">
          <p class="text-slate-300">&copy; 2024 FitFuel. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </footer>
