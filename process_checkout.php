...
try {
    ...
    $pdo->commit();
    audit_log('checkout', 'purchase', 'success', ['user_id'=>$user_id], ['order_id'=>$order_id, 'total_amount'=>$total_amount, 'payment_method'=>$payment_method]);
    ...
    audit_log('checkout', 'purchase', 'failure', ['user_id'=>$user_id ?? null], ['error'=>$e->getMessage()]);
