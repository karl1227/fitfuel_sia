...
$lowStockStmt = $pdo->query("SELECT product_id, name, stock, min_stock_level, images FROM products WHERE stock <= min_stock_level AND status = 'active' ORDER BY stock ASC LIMIT 5");
                    ...
                    <li class="py-3 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-500">Stock: <?php echo (int)$it['stock']; ?> / Min: <?php echo (int)$it['min_stock_level']; ?></div>
                            </div>
                        </div>
